              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _kScheduleColor.withOpacity(0.15),
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: !vm.formPaymentMethodSet
                                  ? _kScheduleColor.withOpacity(0.2)
                                  : Colors.white10,
                              borderRadius: BorderRadius.circular(10),
      ...
      children: List.generate(7, (dow) {
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: isOn
                  ? _kScheduleColor.withOpacity(0.25)
                  : Colors.white10,
              borderRadius: BorderRadius.circular(10),
              border: isOn
                  ...
                  return Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isSelected
                              ? _kScheduleColor.withOpacity(0.15)
